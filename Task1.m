...
% в даному випадку вимірювання відбувається спочатку по стовбчиках а потім
% по рядку (результатам стовпчиків), можливо це може призвести до відмінних
% результатів, тому варто зіставити коли матриця перетворюється у вектор
